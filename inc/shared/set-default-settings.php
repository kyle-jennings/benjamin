...
/**
 * Sets the default sortables for the header
 *
 * @return [type] [description]
 */
function benjamin_get_default_header_sortables() {
...
/**
 * Sets the default sortables for the footer
 *
 * @return [type] [description]
 */
...
function benjamin_set_default_settings() {
	...
	if ( ! get_theme_mod( 'header_sortables_setting' ) ) {
		set_theme_mod( 'header_sortables_setting', benjamin_get_default_header_sortables() );
	}
...
/**
 * Sets the default order fo the header components.
 *
 * @return [type] [description]
 */

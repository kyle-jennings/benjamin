...
function benjamin_frontpage_settings($wp_customize) {
	...
	$wp_customize->add_setting(
		'frontpage_hero_content_setting',
		array(
			'default'           => 'callout',
	...
	$wp_customize->add_control(
		'frontpage_hero_content_control',
		array(
	...
	$wp_customize->add_setting(
		'frontpage_hero_callout_setting',
		array(
			'default'           => '',
	...
	$wp_customize->add_control(
		'frontpage_hero_callout_control',
		array(
	...
	$description = __(
		'The page content is sortable, and optional.  Simply drag the 
		available components from the "available" box over to "active".  Once a widget 
		area has been dragged to "active" you\'ll need to add some ',
		'benjamin'
	);

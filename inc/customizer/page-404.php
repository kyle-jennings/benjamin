...
function benjamin_404_settings( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'_404_header_page_content_setting',
		array(
			'default'           => 0,
	...
	$wp_customize->add_control(
		'_404_header_page_content_control',
		array(

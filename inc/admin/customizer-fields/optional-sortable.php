...
class USWDS_Activated_Sortable_Custom_Control extends WP_Customize_Control
{
    ...
    */
    ...
    ?>
        ...
        <div class="sortables js--sortables" id="<?php echo $this->id; ?>"
            data-setting="<?php echo $this->setting->id; ?>">

            <div>
                <h4 class="sortables__list-title">Active</h4>
                <ol class="sortables__list js--sortables-list sortables__active-list
                    js--sortables-active"
            ...
            <div>
                ...
                <ol class="sortables__list js--sortables-list js--sortables-available"
                data-sortable-group="<?php echo $this->id ?>"
                >

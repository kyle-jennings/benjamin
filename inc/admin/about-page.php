...
/**
 * Enqueues scripts for the about page in the backend
 *
...
function benjamin_about_theme_page() {
	...
	<div class="wrap">
		...
		<p>
			<?php
			echo esc_html__(
				'Use WordPress\'s Customizer to preview changes to your site\'s settings in real time. 
				Configure every part of your site\'s layout, how the homepage acts, your 404 page, your header 
				and footer, and so much more. With the Customizer, you can personalize your site and really make it yours.',
				'benjamin'
			);
			?>
		</p>
